defmodule RemoteControlCar do
  ...
  def drive(%RemoteControlCar{battery_percentage: b, distance_driven_in_meters: d} = remote_car), do: %{remote_car | distance_driven_in_meters: d + 20, battery_percentage: b - 1}
end
