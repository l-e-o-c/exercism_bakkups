defmodule RemoteControlCar do
  ...
  def drive(%RemoteControlCar{} = remote_car), do: %{remote_car | distance_driven_in_meters: remote_car.distance_driven_in_meters + 20, battery_percentage: remote_car.battery_percentage - 1}
end
